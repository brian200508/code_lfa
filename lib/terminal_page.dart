...
import 'custom_keyboard_bar.dart';
...
class _TerminalPageState extends State<TerminalPage> {
  ...
  late CustomKeyboardController keyboardController;

  @override
  void initState() {
    super.initState();
    keyboardController = CustomKeyboardController(terminal: controller.terminal);
  }
