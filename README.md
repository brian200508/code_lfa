...
- Supports the latest version 4.118.0
...
1. Create a file named `code_version` in /sdcard with the version number as its content, such as `4.118.0`, without any line breaks.

2. Download code-server such as [code-server-4.118.0-linux-arm64.tar.gz](https://github.com/coder/code-server/releases/download/v4.13.0/code-server-4.118.0-linux-arm64.tar.gz)
