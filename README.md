...
- Supports the latest version 4.109.5
...
1. Create a file named `code_version` in /sdcard with the version number as its content, such as `4.109.5`, without any line breaks.

2. Download code-server such as [code-server-4.109.5-linux-arm64.tar.gz](https://github.com/coder/code-server/releases/download/v4.13.0/code-server-4.109.5-linux-arm64.tar.gz)
