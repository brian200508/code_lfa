...
- Supports the latest version 4.114.1
...
1. Create a file named `code_version` in /sdcard with the version number as its content, such as `4.114.1`, without any line breaks.

2. Download code-server such as [code-server-4.114.1-linux-arm64.tar.gz](https://github.com/coder/code-server/releases/download/v4.13.0/code-server-4.114.1-linux-arm64.tar.gz)
